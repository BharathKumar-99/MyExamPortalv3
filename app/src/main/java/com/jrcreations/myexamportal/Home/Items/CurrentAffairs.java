...
public class CurrentAffairs extends Fragment {
    ...
    public static CurrentAffairs newInstance(String param1, String param2) {
        CurrentAffairs fragment = new CurrentAffairs();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_current_affairs, container, false);
        mockTestModels=new ArrayList<>();
        recyclerView=view.findViewById(R.id.carec);
