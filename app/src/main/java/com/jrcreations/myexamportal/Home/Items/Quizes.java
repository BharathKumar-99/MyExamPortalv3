...
import com.jrcreations.myexamportal.Home.RecycleView.QuizesRecycle;
...
public class Quizes extends Fragment {
    ...
    public static Quizes newInstance(String param1, String param2) {
        Quizes fragment = new Quizes();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=view.findViewById(R.id.quizrec);

        recyclerView.setHasFixedSize(true);

        recyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
        adapter=new QuizesRecycle(getContext(),mockTestModels);
