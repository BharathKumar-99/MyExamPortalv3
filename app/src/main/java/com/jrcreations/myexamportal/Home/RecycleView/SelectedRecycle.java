...
public class SelectedRecycle  extends RecyclerView.Adapter<SelectedRecycle.ViewHolder>{

    private Context context;
    private List<MockTestModel> list;

    public SelectedRecycle(Context context, List<MockTestModel> list) {
    ...
    @NonNull
    @Override
    public SelectedRecycle.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.selectedui_block, parent, false);
        return new SelectedRecycle.ViewHolder(v);
    }
